<template>
    <div v-if="notify">
        <div v-for="(user, index) in users" :key="index" @click="startChat(user.id)" class="dc-userinbox" :class="[active_id===user.id ? 'dc-active' : '' , user.status_class]">
            <figure><img :src="user.image" :alt="user.image_name"></figure>
    ...
    <div v-else>
        <div v-for="(user, index) in users" :key="index" @click="startChat(user.id)" class="dc-userinbox" :class="[active_id===user.id ? 'dc-active' : '']">
