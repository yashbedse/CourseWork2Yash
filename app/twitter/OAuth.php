 ...
 * verified way to the Doctreat, in a manner which is beyond the scope of this 
 * specification.
...
class OAuthServer {
  ...
  private function get_version(&$request) {
    ...
    if (!$version) {
      // Doctreat MUST assume the protocol version to be 1.0 if this parameter is not present. 
